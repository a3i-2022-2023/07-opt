...
This tutorial in particular tackles the problem of how Machine Learning and Combinatorial Optimization can be integrated, by operating at the modeling level. In particular, the lecture will cover Empirical Model Learning and Decision-Focused Learning.
...
```sh
git clone https://github.com/a3i-2022-2023/07-opt
```
